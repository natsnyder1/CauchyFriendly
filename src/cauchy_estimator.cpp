...
void test_cauchy_3_state_moshe()
{
  ...
  double b0[n] = {0, 0, 0};
  const int steps = 8;
  CauchyEstimator cauchyEst(A0, p0, b0, steps, n, cmcc, p);
  double zs[steps] = {0.056658570969158, -0.142753984516164, -1.205346279653962, 1.378810275944929, -0.531562515031748, -1.019512573307872, -0.597247860048719, -0.710687942924685};
  for(int j = 0; j < 1; j++)
  {
